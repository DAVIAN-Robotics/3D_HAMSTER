...
class MDMModel(nn.Module):
    ...
    def forward(self, 
        ...
        # Resize --> upsampling happend up to 16x. Resize it to match patch size
    ...
    def forward_feat(self, 
        ...
        # Ensure depth matches image dtype to avoid dtype mismatch errors
        # (especially important when model is converted to bfloat16 by DeepSpeed)
